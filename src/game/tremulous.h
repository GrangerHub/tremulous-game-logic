...
#define LEVEL2_CLAW_DMG             AWDM(400)
...
#define LEVEL3_POUNCE_DMG           AWDM(1000)
...
#define OVERMIND_HEALTH             ABHM(7500)
#define OVERMIND_REGEN              60
...
#define GRENADE_DAMAGE              HWDM(3100)
...
#define REACTOR_HEALTH              HBHM(9300)
