...
#define LEVEL0_BITE_DMG             AWDM(36000)
...
#define LEVEL4_HEALTH               AHM(350000)
...
#define ACIDTUBE_DAMAGE             ABDM(8000)
...
#define ALIEN_SPAWN_REPEAT_TIME     250
...
#define LCANNON_SECONDARY_DAMAGE    HWDM(30000)
...
#define TESLAGEN_DMG                HBDM(10000)
...
#define HUMAN_SPAWN_REPEAT_TIME     250
