...
#define LIGHTNING_BOLT_DPS             HWDM(15000)
...
#define LIGHTNING_BALL_REPEAT          500
#define LIGHTNING_BALL_BURST_ROUNDS    4
#define LIGHTNING_BALL_BURST_DELAY     2000
#define LIGHTNING_BALL_LIFETIME        5000
#define LIGHTNING_BALL_DAMAGE          HWDM( 15000 )
#define LIGHTNING_BALL_SPLASH_DMG      HWDM( 15000 )
