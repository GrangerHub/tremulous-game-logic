...
#define MAX_BASEPARTICLE_SYSTEMS  256
...
typedef struct
{
  ...
  float         evolveCoolDownMeterAlpha;
  float         evolveCoolDownMeterValue;
  float         overheatMeterAlpha;
  float         overheatMeterValue;
...
extern  vmCvar_t    cg_lanternLightIntensity;
extern  vmCvar_t    cg_lanternLightRange;
extern  vmCvar_t    cg_lanternLightYaw;
extern  vmCvar_t    cg_lanternLightPitch;
extern  vmCvar_t    cg_lanternLightClip;
...
extern  vmCvar_t    cg_hitIndicator;
...
extern  vmCvar_t    cg_drawEvolveVision;
extern  vmCvar_t    cg_drawInvisibleVision;
