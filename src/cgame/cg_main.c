...
static cvarTable_t cvarTable[ ] =
{
  ...
  { &cg_bunnyHopMode, "cg_bunnyHopMode", "2", CVAR_ARCHIVE|CVAR_USERINFO },
...
static void CG_RegisterSounds( void )
{
  ...
  cgs.media.invis_warp_sound        = trap_S_RegisterSound("sound/misc/invis_warp_sound.wav", qfalse);
...
static void CG_RegisterGraphics( void )
{
  ...
  cgs.media.invisVisionShader    = trap_R_RegisterShader("gfx/misc/invis_view");
  ...
  cgs.media.spitfireWingsGibPS        = CG_RegisterParticleSystem( "spitfireWingsGibsPS" );
